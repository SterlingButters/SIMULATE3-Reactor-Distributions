...
read_file = "cycle01_TFU.out"

# need odds only
seeking_strings = ["ROW  1/01", "ROW  2/02", "ROW  3/03", "ROW  4/04", "ROW  5/05", "ROW  6/06", "ROW  7/07", "ROW  8/08", "ROW  9/09", "ROW 10/10", "ROW 11/11", "ROW 12/12", "ROW 13/13", "ROW 14/14", "ROW 15/15"]
# print(seeking_strings)
...
color_matrices = color_matrices*2
